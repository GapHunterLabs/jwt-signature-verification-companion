package dev.gaphunter.jwtsignatureverificationcompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.jwtsignatureverificationcompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.jwtsignatureverificationcompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "JWT Signature Verification Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33813-jwt-signature-verification-companion/reviews"
